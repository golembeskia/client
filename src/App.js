  ...
  return (
    <>
      ...
      <Switch>
        ...
        <AdminRoute exact path="/admin/diet" component={DietCreate} />
        <AdminRoute exact path="/admin/ingredient" component={IngredientCreate} />
        <AdminRoute
          exact
        ...
        />
          <AdminRoute
          exact
          path="/admin/diet/:slug"
          component={DietUpdate}
        />
        <AdminRoute
          exact
          path="/admin/ingredient/:slug"
        ...
        <Route exact path="/diet/:slug" component={DietHome} />
        <Route exact path="/ingredient/:slug" component={IngredientHome} />
